function setup() {
    ...
    text(digit6, 75 + 0 * 75, 100 + 37.5);
    text(digit5, 75 + 1 * 75, 100 + 37.5);
    text(digit4, 75 + 2 * 75, 100 + 37.5);
    text(digit3, 75 + 3 * 75, 100 + 37.5);
    text(digit2, 75 + 4 * 75, 100 + 37.5);
    text(digit1, 75 + 5 * 75, 100 + 37.5);
}
